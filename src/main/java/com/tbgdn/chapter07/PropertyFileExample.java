...
public class PropertyFileExample implements RunningExample {
    ...
    public void run(String[] args) {
        ...
        PropertyFileLoader listener = new PropertyFileLoader();
        walker.walk(listener, tree);
        listener.getProperties().forEach((key, value) -> System.out.println(MessageFormat.format("{0}={1}", key, value)));
    }
}
